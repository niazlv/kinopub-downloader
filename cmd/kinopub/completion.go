...
complete -c kinopub -n "not __fish_seen_subcommand_from $subcommands" -s f -l format         -d "Pick by -F ids or patterns joined with + (e.g. 1080p-h264+a1+s1, or 'rus+!jpn' in single quotes)" -r
